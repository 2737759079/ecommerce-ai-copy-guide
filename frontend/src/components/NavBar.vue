<template>
  <nav class="sticky top-0 z-50 glass border-b border-primary-light/50 shadow-sm">
        ...
        <div class="flex items-center space-x-8">
          ...
          <div class="hidden md:flex space-x-1">
            <router-link
              ...
              :key="item.path"
              :to="item.path"
              :class="route.path === item.path ? 'text-primary bg-primary-light' : 'text-gray-600 hover:text-primary hover:bg-primary-light/50'"
...
const menu = [
  ...
  { name: '客服咨询', path: '/customer-service', icon: ChatBubbleLeftRightIcon },
